    ...
    public abstract class CustomerMainDocument : MainDocumentBase
    {
        ...
        protected bool CheckDocumenInicializationOK()
        {
            using (var db = new TecserData(GlobalApp.CnnApp))
            {
                ...
                IdCustomer = header400.Cliente.Value;
                ...
                {
                    ExchangeRate = header400.TC.Value;
                }
        ...
        protected void AddRecordCtaCteFromFactura(T0400_FACTURA_H facturaH)
        {
            using (var db = new TecserData(GlobalApp.CnnApp))
            {
                ...
                documento201.IDCLI = facturaH.Cliente.Value; //todo convertir a not null
        ...
        protected void AddRecordTabla207(T0400_FACTURA_H facturaH)
        {
            using (var db = new TecserData(GlobalApp.CnnApp))
            {
                var t207 = new T0207_SPLITFACTURAS
                {
                    ...
                    FACT_MONTO = facturaH.TotalFacturaN,
                    MONTO = facturaH.TotalFacturaN,
                    MONTO_APLICADO = 0,
                ...
                IdTabla207 = db.SaveChanges() > 0 ? t207.INTDOC.Value : 0;
            }
        }
        ...
        public bool CancelaDocumentoFI(int idFactura)
        {
            using (var db = new TecserData(GlobalApp.CnnApp))
            {
                ...
                var x = new AsientoCustomerDocument(idFactura,"FAC2").ReversaAsiento(f400.NAS.Value,"Cancelacion de Documento");
