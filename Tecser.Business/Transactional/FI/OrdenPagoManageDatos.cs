...
namespace Tecser.Business.Transactional.FI
{
    public class OrdenPagoManageDatos
    {
        ...
        {
            return new TecserData(GlobalApp.CnnApp).T0213_OP_FACT.Where(c => c.IDOP == _numeroOP).OrderBy(c => c.IDITEM).ToList();
        }
        ...
        /// </summary>
        public bool AddItemPago(string cuenta, decimal importe, int idCheque = -1, decimal tc = 0)
        {
