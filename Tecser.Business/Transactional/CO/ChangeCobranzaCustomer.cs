    ...
    public class ChangeCobranzaCustomer
    {
        ...
        public void ChangeCobranzaToAnotherCustomer(int idCobranza, int nuevoCliente)
        {
            using (var db = new TecserData(GlobalApp.CnnApp))
            {
                ...
                int idClienteOriginal = dataCobranza.CLIENTE.Value;
                dataCobranza.CLIENTE = nuevoCliente;
                ...
                ctaOri.UpdateSaldoCtaCteResumen(dataCobranza.CUENTA, dataCobranza.Monto.Value, dataCobranza.MON,dataCobranza.TC);
                ...
                ctaNew.UpdateSaldoCtaCteResumen(dataCobranza.CUENTA, dataCobranza.Monto.Value*-1, dataCobranza.MON,
                    dataCobranza.TC);
