...
namespace Tecser.Business.Transactional.CO.ContaFromDocuments
{
    ...
    public class ContaCustomerFromInvoice : ContaCustomerDocument
    {
        ...
        protected sealed override void SetTipoDocumento()
        {
            ...
            //    ? ManageDocumentType.TipoDocumento.FacturaVentaA
            //    : ManageDocumentType.TipoDocumento.FacturaVenta2;
            //TipoDocSystem =ManageDocumentType.GetSystemDocumentType(TipoDocumento);
        ...
        public override ReturnContaCustomerDocument ManageContabilizacionCompleta()
        {
            ...
            //Esto se movio de aca y se va a manejar despues de pedir el CAE con el numero real de documento
            //if (H400.TotalIIBB > 0)
            //{
            //    new PercepcionesManager().AddFacturaPercepcion(H400.IDFACTURAX.Value);
            //}
            ...
            var asiento = new AsientoCustomerDocument(IdFactura, base.Tcode);
        ...
        protected override void AddRecordCtaCteDetalle201207()
        {
            ...
            var idCtaCte = data.AddCtaCteDetalleRecord(TipoDocSystem, TipoLx, H400.FECHA.Value, NumeroDocumento,
                IdFacturaX.ToString(), H400.FacturaMoneda, H400.TotalFacturaN, H400.TC.Value, H400.TotalFacturaN, 0,
