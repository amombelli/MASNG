...
namespace Tecser.Business.Transactional.CO.AsientoContable.Modules
{
    public class AsientoOrdenPago:AsientoVendorSpecific
    {
        ...
        private void AddSegmentoItemsPago()
        {
            ...
            foreach (var i in _items)
            {
                ...
                if (i.CUENTA_O != "OPCRED")
                {
                    ...
                    AddGenericCompleteSegment(TipoDocumento, NumeroDocumento, _h.TIPO, glAccountItemPago, descripcion1,
                        descripcion2,
                        _h.MON_OP, DebeHaber.Haber, (decimal) i.IMPORTE_OP, Tcode, 0, IdVendor, "T0212_OP_ITEM",
                        i.IDITEM);
                }
            }
        }
        public IdentificacionAsiento GeneraAsientoFromOrdenPago()
        {
            ...
            CreacionHeaderAsiento(_h.TIPO, _h.OPFECHA.Value, TipoDocumento, _idOP.ToString(), descripcionHeader, _h.MON_OP,
