namespace Tecser.Business.Transactional.CO.AsientoContable
{
    ...
    public abstract class AsientoVendorSpecific : AsientoBase
    {
        ...
        protected void GeneraSegmentoAP(string tipoDocumento, string numeroDocumento, string tipoLx, DebeHaber DH, string moneda, decimal importe, string tableName, int idTableName)
        {
        ...
        protected void AddSegmentoRetencionesAProveedores(GLAccountManagement.GLAccount tipoImpuesto, decimal importeImpuesto, string moneda = "ARS", decimal? alicuota = 0, string distrito = null,
       string nombreTablaReferencia = "_T0210_OP_H", int idTablaReferencia = 0)
         ...
         string nombreTablaReferencia = "T0403_VENDOR_FACT_H", int idTablaReferencia = 0)
        {
            ...
            AddGenericCompleteSegment("IMP", Header.REFE, Header.TIPO, glAccount, descripcion1, descripcion2, moneda,
                DebeHaber.Debe,importeImpuesto, Tcode, 0, idVendor,nombreTablaReferencia, idNumerico: idTablaReferencia);
        }
