...
namespace Tecser.Business.Transactional.PP
{
    public class PlanProduccionStatusManager
    {
        ...
        /// </summary>
        public static bool SetStatusFormulada(int idOF, int numeroFormula)
        {
            if (numeroFormula <= 0)
                return false;
            ...
            using (var db = new TecserData(GlobalApp.CnnApp))
            {
                ...
                if (data.KG_FABRICAR <= 0 || data.KG_FABRICAR == null)
                    return false;
                ...
                oMng.CalculaBatchSize(idOF, data.KG_FABRICAR.Value, true);
