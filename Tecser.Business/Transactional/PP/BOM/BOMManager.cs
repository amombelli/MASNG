...
namespace Tecser.Business.Transactional.PP
{
    ...
    {
        /// <summary>
        /// Lista todos los materiales que PUEDEN tener una BOM
        /// </summary>
        public List<string> GetLisMaterialsAllowToHaveBOM()
        {
            using (var db = new TecserData(GlobalApp.CnnApp))
            {
                return db.T0010_MATERIALES.Where(c => c.T0012_TIPO_MATERIAL.DISPO_OF).Select(c => c.IDMATERIAL).ToList();
            }
        }
        /// <summary>
