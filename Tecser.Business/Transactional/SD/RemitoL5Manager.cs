    ...
    public class RemitoL5Manager
    {
        public void SetRemitoL2L5(int idRemitoL1L5)
        {
            using (var db = new TecserData(GlobalApp.CnnApp))
            {
                ...
                //var itemsL1 = db.T0056_REMITO_I.Where(c => c.IDREMITO == idRemitoL1L5 && c.L5.Value).ToList();
                //foreach (var itemL1 in itemsL1)
                //{
                //    var itemL2 = db.T0056_REMITO_I.SingleOrDefault(c=>c.IDREMITO == itemL1.RLINK && c.IDOVITEM == itemL1.IDOVITEM && c.IDOV == itemL1.IDOV && c.idStockComprometido == itemL1.idStockComprometido);
                //    if (itemL2 == null)
                //    {
