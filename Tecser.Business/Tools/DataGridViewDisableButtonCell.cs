            ...
            DataGridViewPaintParts paintParts)
        {
            ...
            if (!_enabledValue)
            {
                ...
                using (var myBuffer = currentContext.Allocate(graphics, cellBounds))
                {
                    ...
                    {
                        TextRenderer.DrawText(myBuffer.Graphics, formattedValueString, DataGridView.Font, buttonArea,
                            SystemColors.GrayText,
                            TextFormatFlags.PreserveGraphicsTranslateTransform | TextFormatFlags.HorizontalCenter |
