...
namespace MASngFE.Reports.ReportManager
{
    ...
    {
        public RpvFacturaL1(int idFactura, bool imprimirMsgMora,string observacion,bool ckImpresionConsolidada)
        {
        ...
        private void RpvFacturaL1_Load(object sender, EventArgs e)
        {
            ...
            parameters[6] = new Microsoft.Reporting.WinForms.ReportParameter("parBarraPath",
                @"file:\\\" + fileBarra + ".jpg");
