...
namespace MASngFE.Reports.ReportManager
{
    ...
    {
        public RpvFacturaL1_PDF(int idFactura,bool imprimirMsgMora, string observacionAdicional, bool ckInfoConsolidada)
        {
        ...
        private void RpvFacturaL1_Preimpreso_Load(object sender, EventArgs e)
        {
            ...
            DateTime fechaF = dataHeader[0].FECHA.Value.Date;
            ...
            parameters[6] = new Microsoft.Reporting.WinForms.ReportParameter("parBarraPath",@"file:\\\" + fileBarra + ".jpg");
