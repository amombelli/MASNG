        ...
        private void btnConfirmarPreparacion_Click(object sender, EventArgs e)
        {
            ...
            using (var db = new TecserData(GlobalApp.CnnApp))
            {
                ...
                if (itemsSinGenerar > 0)
                {
                    ...
                    {
                        using (
                            FrmConfirmacionPreparacion f = new FrmConfirmacionPreparacion(_idRemitoSeleccionado.Value))
                        {
                ...
                {
                    using (FrmConfirmacionPreparacion f = new FrmConfirmacionPreparacion(_idRemitoSeleccionado.Value))
                    {
                        DialogResult dr0 = f.ShowDialog();
                        if (dr0 == DialogResult.OK)
                        {
