...
#pragma warning disable CS0169 // The field 'FrmSalesOrderItemDetail.totalKgComprometidos' is never used
        private decimal totalKgComprometidos;
#pragma warning restore CS0169 // The field 'FrmSalesOrderItemDetail.totalKgComprometidos' is never used
        ...
        private void LoadItemData()
        {
            ...
            if (data != null)
            {
                ...
                {
                    txtKGdespachados.Text = data.KGStockDespachados.Value.ToString("N2");
                }
                txtKgPendienteDespacho.Text = (data.Cantidad - data.KGStockDespachados.Value).ToString("N2");
                ...
                txtPrecioL1.Text = data.PRECIO1.ToString();
                txtPrecioL2.Text = data.PRECIO2.ToString();
                txtPrecioTotal.Text = data.PRECIOTOTAL.ToString();
                txtKgStockReservados.Text = data.KGStockComprometido.ToString();
        ...
        {
            MotivoSc motivoSinCargo = MotivoSc.NoAplica;
            ...
            if (Convert.ToInt32(FormatAndConversions.CCurrencyADecimal(txtPrecioTotal.Text)) == 0)
            {
                ...
                using (var f0 = new FrmMotivoSinCargo(_idSO, 0, cmbMaterialAKA.SelectedValue.ToString(), _idCliente6))
                {
            ...
            if (motivoSinCargo != MotivoSc.NoAplica)
            {
        ...
        private void btnGuardarEdicion_Click(object sender, EventArgs e)
        {
            ...
            var itemToUpdate = new T0046_OV_ITEM
            {
                ...
                PRECIO1 = FormatAndConversions.CCurrencyADecimal(txtPrecioL1.Text),
                PRECIO2 = FormatAndConversions.CCurrencyADecimal(txtPrecioL2.Text),
                PRECIOTOTAL = FormatAndConversions.CCurrencyADecimal(txtPrecioL1.Text) + FormatAndConversions.CCurrencyADecimal(txtPrecioL2.Text),
        ...
        private void btnCRMProductos_Click(object sender, EventArgs e)
        {
