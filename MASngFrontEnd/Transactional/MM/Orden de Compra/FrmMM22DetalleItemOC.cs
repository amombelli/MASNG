...
namespace MASngFE.Transactional.MM.Orden_de_Compra
{
    public partial class FrmMM22DetalleItemOC : Form
    {
        ...
        private void AccionSegunEstadoItem()
        {
        }

        private void rbSoloProveedor_CheckedChanged(object sender, EventArgs e)
        {
            t0010MATERIALESBindingSource.DataSource = rbSoloProveedor.Checked ? new MaterialMasterManager().GetListMaterialSuppliedByVendor(frmOcHeader.IdProv) : new MaterialMasterManager().GetListMaterialAvailableToBuy();
        }
        ...
        private void cmbMaterial_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                var infoR = new VendorInfoRecordManager().GetInfoRecordMaterialVendor(_idProveedor, cmbMaterial.SelectedValue.ToString());
