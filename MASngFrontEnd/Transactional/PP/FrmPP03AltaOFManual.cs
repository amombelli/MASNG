...
namespace MASngFE.Transactional.PP
{
    public partial class FrmPP03AltaOFManual : Form
    {
        ...
        {
            cmbMaterial.DataSource = new MaterialMasterManager().GetListMaterialAvailableToManufacture();
            txtUsuario.Text = Environment.UserName;
            txtFechaLog.Text = DateTime.Today.ToString();
        ...
        private void cmbMaterial_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                txtDescripcion.Text =
                    MaterialMasterManager.GetSpecificPrimaryInformation(cmbMaterial.SelectedValue.ToString()).MAT_DESC;
            }
        }
        ...
        private void btnAddOF_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                var ofn = new PlanProduccionManager().AddPlanProduccion(cmbMaterial.SelectedValue.ToString(),
                    ...
                    txtNombreCliente.Text,false,true);
