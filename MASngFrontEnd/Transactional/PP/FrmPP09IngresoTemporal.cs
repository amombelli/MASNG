...
namespace MASngFE.Transactional.PP
{
    public partial class FrmPP09IngresoTemporal : Form
    {
        ...
        {
            //
            t0085PERSONALBindingSource.DataSource = new HumanResourcesManager().GetListAllActiveOperario();
        ...
        private void CargaDatosOF()
        {
            ...
            if (ofData != null)
            {
                ...
                txtKgingresados.Text = ofData.KG_Fabricados == null
                    ? 0.ToString("N2")
                    : ofData.KG_Fabricados.Value.ToString("N2");

                if (ofData.Operario != null)
                    cmbOperador.SelectedValue = ofData.Operario;
        ...
        private void btnIngresoTemporal_Click(object sender, EventArgs e)
        {
            ...
            new IngresoStockProduccion().IngresoStockProductoFabricado(_numeroOF, dtpFechaIngresoProduccion.Value,
                ...
                Convert.ToInt32(cmbRecurso.SelectedValue), cmbOperador.SelectedValue.ToString(),
