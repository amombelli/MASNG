...
namespace MASngFE.Transactional.PP
{
    public partial class FrmPP18UpdateKgFabricar : Form
    {
        ...
        private void FrmPP18UpdateKgFabricar_Load(object sender, EventArgs e)
        {
            ...
            txtOVnum.Text = dataPf.OV != null ? null : dataPf.OV.Value.ToString();
            
            txtKgIngresoPlan.Text = dataPf.KG_FABRICAR_O.Value.ToString("N2");
            txtKgRevisado.SetValue = dataPf.KG_FABRICAR.Value;
