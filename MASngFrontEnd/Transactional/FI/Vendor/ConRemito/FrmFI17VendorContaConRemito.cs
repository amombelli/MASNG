...
using MASngFE.Transactional.FI.ContabilizacioFactura.ConRemito;
    ...
    public partial class FrmFI17VendorContaConRemito : Form
    {
        ...
        private void ManageContabilizacionCompleta()
        {
            ...
            foreach (var ix in Items)
            {
                ...
                {
                    new CostoReposicion().AddUpdateCosto(ix.Material, ix.CantidadFacturar, ix.MonedaPrecioUc, ix.TC,
                        ix.PrecioUnitarioUc, IdVendor.Value, _fechaDocumento.Value, GlobalApp.AppUsername);
                }
                ...
                //caducado el costo en T0033_COSTO
                //if (ix.IncluirEVP)
                //{
                //    new CostoReposicion().AddCostoUltimaCompra(ix.Id63, _fechaDocumento.Value);
                //}
            }
