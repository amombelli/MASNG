...
{
    public partial class FrmSeleccionDocAjustePrecioU : Form
    {
        public FrmSeleccionDocAjustePrecioU(ManageDocumentType.TipoDocumento tdoc, string lx, int idCliente)
        {
            _tdocumento = tdoc;
            _lx = lx;
