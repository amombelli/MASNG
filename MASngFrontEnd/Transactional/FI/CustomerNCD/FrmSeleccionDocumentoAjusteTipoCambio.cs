...
{
    public partial class FrmSeleccionDocumentoAjusteTipoCambio : Form
    {
        public FrmSeleccionDocumentoAjusteTipoCambio(ManageDocumentType.TipoDocumento tdoc, string lx, int idCliente)
        {
            _tdocumento = tdoc;
            _lx = lx;
        ...
        private void FrmSeleccionDocumentoAjusteTipoCambio_Load(object sender, EventArgs e)
        {
            ...
            t0400FACTURAHBindingSource.DataSource = new NCDAnulaDocumento().GetListaDocumentos(_idCliente, _lx).ToList();
        ...
        private void txtNewTc_KeyPress(object sender, KeyPressEventArgs e)
       {
        ...
        private void dgvFactuHeader_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            new FixFactuPreciosToNewModel().FixFacturaPrecios(IdFacturaSeleccionada);
