...
{
    public partial class FrmSecurityModule : Form
    {
        public FrmSecurityModule(int modo=0)
        {
            InitializeComponent();
        }
        ...
        private void cmbRole_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (dataRole != null)
            {
                if (dataRole.IsTcode == null)
                    dataRole.IsTcode = false;

                ckTcode.Checked = dataRole.IsTcode.Value;
                RoleSeleccion();
            }
        }
        ...
        {
            using (var f1 = new FrmSec03RoleManagement())
            {
        ...
        private void btnEditRole_Click(object sender, EventArgs e)
        {
            ...
            using (var f1 = new FrmSec03RoleManagement(cmbRole.SelectedValue.ToString()))
            {
                var dr = f1.ShowDialog();
                if (dr == DialogResult.OK)
                {
        ...
        {
            using (var f1 = new FrmSec02TcodeManagement())
            {
                var dr = f1.ShowDialog();
                if (dr == DialogResult.OK)
                {
        ...
        private void btnEditTcode_Click(object sender, EventArgs e)
        {
            ...
            using (var f1 = new FrmSec02TcodeManagement(cmbRole.SelectedValue.ToString()))
            {
                var dr = f1.ShowDialog();
                if (dr == DialogResult.OK)
                {
