...
namespace MASngFE.MasterData
{
    public partial class FrmVendorSearch : Form
    {
        ...
        {
            var f2 = new FrmVendorDetailData(1,0);
            {
            };
            f2.Show();
        }
        ...
        {
            var f2 = new FrmVendorDetailData(3, (int)cmbIdVendor.SelectedValue);
            {
            };
            f2.Show();
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                var f2 = new FrmVendorDetailData(2, (int)cmbIdVendor.SelectedValue);
                {
                }
                ;
                f2.Show();
