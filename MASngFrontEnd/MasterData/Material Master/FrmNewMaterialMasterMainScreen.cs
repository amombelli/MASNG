...
{
    public partial class FrmNewMaterialMasterMainScreen : Form
    {

        //Constructor creacion de material
        public FrmNewMaterialMasterMainScreen(int modo = 1)
        {
        ...
        public FrmNewMaterialMasterMainScreen(int modo, int nelNumber)
        {
            if (!Tecser.Business.Security.TsSecurityMng.CheckifRoleIsGrantedToRun("MM1", "MM2"))
            {
                MessageBox.Show(@"El Usuario no cuenta con los permisos necesarios para ingresar a esta transaccion",
        ...
        public FrmNewMaterialMasterMainScreen(int modo, string primario)
        {
        ...
        private void FormConfig()
        {
            ...
            t0011MaterialTypeBindingSource.DataSource = new MaterialTypeBusinessRules().GetListMtype();
            ...
            EnvasesBs.DataSource = new MaterialMasterManager().GetListaEnvases();
        ...
        private void CargaPrimaryData()
        {
            ...
            _tipoMaterialSeleccionado = new MaterialTypeBusinessRules().GetMtype(_primarioData.TIPO_MATERIAL);
        ...
        private bool ValidationToSave()
        {
            ...
            //if (_tipoMaterialSeleccionado.)
            //{
            //    vx.Valida(cmbCarrier, cmbCarrier.SelectedItem == null, "Debe proveer la base del material/carrier");
            //}
        ...
        private void AccionSegunTipoMaterialByConfigTable()
        {
            if (_modo == 1)
            {
                ...
                cmbOrigen.SelectedValue = _tipoMaterialSeleccionado.OrigenDefault;
        ...
        private T0010_MATERIALES MapMaterialT0010ScreenData()
        {
            ...
            var materialData = new T0010_MATERIALES()
            {
                ...
                MAT_DESC_L5 = "", //todo: eliminar este campo cuando se arregle desc-remitos
                MAT_DESC = txtDescripcionOF.Text, //todo: eliminar este campo
                MAT_DESC2 = txtDescripcionTecnica.Text, //todo: eliminar este campo
                LogCreadoFecha = Convert.ToDateTime(txtCreadoEn.Text),
        ...
        private void cmbEnvase_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                var data = (T0010_MATERIALES) cmbEnvase.SelectedItem;
                txtDescripcionEnvase.Text = data.DescripcionFormulacion;
            }
            else
            {
                txtDescripcionEnvase.Text = null;
