...
namespace MASngFE.MasterData.Material_Master
{
    public partial class FrmMasterDataSearchScreen : Form
    {
        ...
        private void cmbMaterial_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            var datosTipo = new TipoMaterialManager().GetTipoMaterialData(txtTipoMaterial.Text);
            txtDescripcionTipoMaterial.Text = datosTipo.DESCRIPCION;
            txtTipoA.Text = dataRtn.TipoT0011;
            txtTipoP.Text = dataRtn.TipoT0010;

            if (datosTipo.DISPO_BOM == null) datosTipo.DISPO_BOM = false;
            if (datosTipo.DISPO_NP == null) datosTipo.DISPO_NP = false;
            if (datosTipo.DISPO_OF == null) datosTipo.DISPO_OF = false;
            if (datosTipo.DISPO_OC == null) datosTipo.DISPO_OC = false;

            if (datosTipo.DISPO_BOM)
            {
        ...
        private void btnDetalleMaterial_Click(object sender, EventArgs e)
        {
            ...
            {
                using (var f = new FrmNewMaterialMasterMainScreen(3, txtCodigoPrimario.Text))
                {
                    f.ShowDialog();
                }
            }
        ...
        private void btnEditMaterial_Click(object sender, EventArgs e)
        {
            ...
            {
                using (var f = new FrmNewMaterialMasterMainScreen(2, txtCodigoPrimario.Text))
                {
                    f.ShowDialog();
                }
            }
