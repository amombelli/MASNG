...
#pragma warning disable CS0168 // The variable 'nro' is declared but never used
#pragma warning disable CS0168 // The variable 'cbteNro' is declared but never used
#pragma warning disable CS0168 // The variable 'tipo' is declared but never used
#pragma warning disable CS0168 // The variable 'fecha' is declared but never used
#pragma warning disable CS0168 // The variable 'ptoVta' is declared but never used
                object tipo, ptoVta, nro, fecha, cbteNro;
#pragma warning restore CS0168 // The variable 'ptoVta' is declared but never used
#pragma warning restore CS0168 // The variable 'fecha' is declared but never used
#pragma warning restore CS0168 // The variable 'tipo' is declared but never used
#pragma warning restore CS0168 // The variable 'cbteNro' is declared but never used
#pragma warning restore CS0168 // The variable 'nro' is declared but never used
                object id, desc, baseImp, alic, importe;
#pragma warning disable CS0168 // The variable 'cae' is declared but never used
                object cae;
#pragma warning restore CS0168 // The variable 'cae' is declared but never used
#pragma warning disable CS0168 // The variable 'lcbteNro' is declared but never used
                long lcbteNro;
#pragma warning restore CS0168 // The variable 'lcbteNro' is declared but never used
                object impIVA;


                // Establezco los valores de la factura a autorizar:

                tipoCbte = GetIdTipoComprobanteAfip(dataStructure.TipoComprobante); //1
                puntoVta = dataStructure.PuntoVenta; //4002
                var ultimoComprobante = _wsfev1.CompUltimoAutorizado(tipoCbte, puntoVta);
                if (string.IsNullOrEmpty(ultimoComprobante))
                {
                    ultimoComprobante = 0;
                }
                else
                {
                    ultimoComprobante = Convert.ToInt64(ultimoComprobante);
                }
                ...
                impOPEx = "0.00";
                fechaCbte = DateTime.Today.ToString("yyyyMMdd");
                fechaVencPago = "";
