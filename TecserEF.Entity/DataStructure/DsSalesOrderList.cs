...
namespace TecserEF.Entity.DataStructure
{
    public class DsSalesOrderList
    {
        ...
        public IEnumerable<DsSalesOrderList> GetAllData(string globalAppCnn)
        {
        ...
        public IEnumerable<DsSalesOrderList> GetByCustomer(int idCliente6,string globalAppCnn)
        {
            using (var db = new TecserData(globalAppCnn))
            {
