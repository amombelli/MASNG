...
namespace TecserEF.Entity
{
    ...
    public partial class T0401_FACTURA_I
    {
        ...
        public Nullable<decimal> PRECIO_ARS { get; set; }
        ...
        public Nullable<decimal> PRECIOU_FACT_ARS { get; set; }
        public Nullable<decimal> PRECIOT_FACT_ARS { get; set; }
        public Nullable<decimal> PRECIOU_FACT_USD { get; set; }
        public Nullable<decimal> PRECIOT_FACT_USD { get; set; }
